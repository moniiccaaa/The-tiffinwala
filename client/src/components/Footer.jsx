  ...
  return (
    <footer>
      ...
      <div className=" py-4 bg-slate-700 text-white">
        <p className='text-normal text-center font-medium sm:text-lg sm:font-serif'>© Copyright 2025-2026 www.TiffinWala.com All rights reserved. Developed by Madhusmita Jena And Mahima Pandey</p>
      </div>
