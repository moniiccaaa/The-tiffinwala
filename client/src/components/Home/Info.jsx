    ...
    <div className='flex w-full sm:flex-row flex-col md:gap-6 gap-2 lg:px-12 md:px-8  px-2 my-8'>
      ...
      <Fade direction='right'>
        <div className='w-full h-full flex flex-col gap-4 items-center justify-center'>
          ...
          <button className='md:w-2/3 px-2 bg-slate-800 rounded-md text-white py-2 md:text-lg md:font-semibold cursor-pointer' onClick={() => navigate("/provider")}>Book Your Tiffin</button>
        </div>
      </Fade>
    </div>
  )
