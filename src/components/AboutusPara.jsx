    ...
    return (
        <>
            ...
            <div className="sm:flex items-center max-w-screen-xl">
                ...
                <div className="sm:w-1/2 p-5">
                    <div className="text">
                        ...
                        <div className="my-5">
                        <Link to="/provider"
                    className="hover:bg-indigo-500 hover:text-white font-medium px-4 py-2 rounded-md bg-blue-500 text-white transition duration-300 ease-in-out">Order Now
                </Link>
                </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-wrap text-center justify-center">
                        <div className="p-4 md:w-1/4 sm:w-1/2">
                            <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                                ...
                                <h2 className="title-font font-normal text-2xl text-gray-900">Latest Milling Machinery</h2>
                            </div>
                        </div>
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2">
                            <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                                ...
                                <h2 className="title-font font-normal text-2xl text-gray-900">Reasonable Rates</h2>
                            </div>
                        </div>
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2">
                            <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                                ...
                                <h2 className="title-font font-normal text-2xl text-gray-900">Time Efficiency</h2>
                            </div>
                        </div>
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2">
                            <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                                ...
                                <h2 className="title-font font-normal text-2xl text-gray-900">Expertise in Industry</h2>
                            </div>
                        </div>
            ...
            <div className="lg:px-96 md:px-20">
                ...
                <p className="text-center text-md text-gray-600 px-4 font-sans py-3">
